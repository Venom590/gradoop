...
import static org.gradoop.model.impl.GradoopFlinkTestUtils.printGraphCollection;

public class CollectionFrequentSugraphMiningTest extends GradoopFlinkTestBase {
  ...
  public void testSingleEdges() throws Exception {
    ...
    collectAndAssertEquals(expectation.equalsByGraphElementData(result));
  }
}